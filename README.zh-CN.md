...
FengShui Master 是一个面向 Codex 的开源风水 Skill，目标是把中国传统风水、五行、阴阳、八卦、干支、吉凶、趋吉避凶与现代跨领域决策支持结合起来。它既能做住宅、办公室、商铺、土地、户型、门、床、书桌、厨房、方位、玄空飞星等空间分析，也能把风水作为广义象义语言，用于人生阶段、生平、运势、金融、商业、品牌、职业、产品、学习、关系与健康相邻环境等问题。
